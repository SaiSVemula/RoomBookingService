...
class Booking(models.Model):
    """Through model representing a booking of a room by a user."""
    ...
    booking_date = models.DateField(default="2024-10-23")  # Automatically sets the date when the booking is created

    # New TimeField to capture the duration of the booking (or some other time-related detail)
